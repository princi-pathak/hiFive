...
const sliderTextSpan = document.querySelector("#sliderText span");

checkbox.addEventListener("change", () => {
  if (checkbox.checked) {
	sliderTextSpan.textContent = "Active";
	sliderTextSpan.classList.remove("inactive-status");
	sliderTextSpan.classList.add("active-status");
  } else {
	sliderTextSpan.textContent = "Inactive";
	sliderTextSpan.classList.remove("active-status");
	sliderTextSpan.classList.add("inactive-status");
  }
});
